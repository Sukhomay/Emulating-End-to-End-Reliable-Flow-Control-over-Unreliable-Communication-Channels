...
/*
    ...
    Workflow: Generates a shared memory key, creates or accesses shared memory segment for MTP table, 
    attaches the segment, and returns the pointer to it.
*/
...
/*
    ...
    Workflow: Generates a shared memory key, creates or accesses shared memory segment for shared variables, 
    attaches the segment, and returns the pointer to it.
*/
...
/*
    ...
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for entry, and 
    stores its id in the provided pointer.
*/
...
/*
    ...
    Arguments: Pointer to int id
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for exit, and 
    stores its id in the provided pointer.
*/
...
/*
    ...
    Arguments: Pointer to int id
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for mutex table info, and 
    stores its id in the provided pointer.
*/
...
/*
    ...
    Arguments: Pointer to int id
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for mutex sliding window, and 
    stores its id in the provided pointer.
*/
...
/*
    ...
    Arguments: Pointer to int id
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for mutex receive buffer, and 
    stores its id in the provided pointer.
*/
...
/*
    ...
    Arguments: Pointer to int id
    Return Value: None
    Workflow: Generates a semaphore key, creates or accesses a semaphore for mutex send buffer, and 
    stores its id in the provided pointer.
*/
